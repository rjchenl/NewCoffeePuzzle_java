...
public class SpndcoffeelistJDBCDAO implements SpndcoffeelistDAO_interface {
	...
	private static final String GETMYSPNDCOFFEELIST ="SELECT P.SPND_PROD,S.STORE_ID,P.LIST_AMT,P.LIST_ID,P.LIST_LEFT,S.STORE_NAME,S.STORE_ADD FROM SPNDCOFFEELIST P JOIN STORE S ON P.STORE_ID = S.STORE_ID WHERE P.MEM_ID = ?";
