...
public class OrderlistVO implements Serializable {
	...
	public OrderlistVO(String ord_id, String mem_id, String store_id, String ord_total, Integer ord_pick, String ord_add, Integer ord_shipping, Timestamp ord_time, Integer score_buyer, Integer score_seller, Integer rept_buyer, String rept_buyer_rsn, Integer rept_buyer_rev, Integer rept_seller, String rept_seller_rsn, Integer rept_seller_rev, Integer ord_isreturn, String return_rsn){
		this.ord_id = ord_id;
		this.mem_id = mem_id;
